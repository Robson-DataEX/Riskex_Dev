...
# 
# # Tabela: riscos.dim_controle
# ## Objetivo:
# Esta tabela contém o catalogo de controles
# 
# -------------
# 
...
SELECT
    ...
    DataHoraExclusao,
    SYNC_DATE,
    ControleIdioma_Descricao,
    insert_date,
    update_date,
    hash_row
FROM {workspace}.lh_silver.riscos.controle
