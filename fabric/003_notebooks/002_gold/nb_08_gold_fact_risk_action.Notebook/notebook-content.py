...
# 
# # Tabela: riscos.fact_risk_action
# ## Objetivo:
# Esta tabela contém os relacionamentos entre Ação e RiscoOcupacional
# 
# -------------
# 
...
SELECT 
    ...
    BowtieId,
    DesvioId,
    AcidenteInvestigacaoId,
    RiscoAntes,
    RiscoDepois,
    RiscoDiff,
    RiscoDetalhes,
    Deletado,
    RiscoOcupacionalJSON,
    AprovacaoProcessamento,
    AprovacaoProcessamentoIniciado,
    insert_date,
    update_date,
    hash_row
FROM {workspace}.lh_silver.riscos.acao_risco
