...
# # Tabela: riscos.fact_occupational_safety_map
# ## Objetivo:
# Tabela de registro de um mapa de segurança ocupacional gerado para uma unidade específica da empresa, listando todos os riscos ocupacionais associados àquela unidade
# 
# -------------
# 
...
table_name = 'fact_occupational_safety_map'
...
SELECT 
    ...
    update_date,
    hash_row
FROM {workspace}.lh_silver.riscos.mapa_seguranca_ocupacional
