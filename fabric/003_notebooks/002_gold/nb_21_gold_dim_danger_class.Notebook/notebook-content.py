...
# # Tabela: riscos.dim_danger_class
# ## Objetivo:
# Tabela de categorias de perigo (Físico, Químico, Biológico, Ergonômico, Acidente)
# 
# -------------
# 
...
SELECT 
    ...
    update_date,
    hash_row
FROM {workspace}.lh_silver.riscos.perigo_classe
