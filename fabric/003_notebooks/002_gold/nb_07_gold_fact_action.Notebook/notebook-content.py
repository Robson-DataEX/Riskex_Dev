...
# # Tabela: riscos.fact_action
# ## Objetivo:
# Esta tabela contém os registros de uma ação individual a ser executada dentro do sistema
# 
# -------------
# 
...
SELECT 
    ...
    Encerrado,
    UsuarioPlanejadorId,
    MoedaSelecionadaSigla,
    insert_date,
    update_date,
    hash_row
FROM {workspace}.lh_silver.riscos.acao
