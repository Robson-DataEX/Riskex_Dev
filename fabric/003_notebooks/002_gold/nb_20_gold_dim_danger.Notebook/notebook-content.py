...
# # Tabela: riscos.dim_danger
# ## Objetivo:
# Tabela de catálogo de perigos identificáveis no ambiente de trabalho, utilizados na criação de riscos ocupacionais
# 
# -------------
# 
...
SELECT 
    ...
    DataHoraExclusao,
    SYNC_DATE,
    PerigoIdioma_Descricao,
    PictogramaId,
    PerigoIdioma_Detalhes,
    EnergiaId,
    insert_date,
    update_date,
    hash_row
FROM {workspace}.lh_silver.riscos.perigo
