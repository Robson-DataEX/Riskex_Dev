...
# # Tabela: riscos.fact_block_lottery
# ## Objetivo:
# Tabela que armazena os pontos de bloqueio associados a um mapa de LOTO (sendo LOTO 1 - N pontos de bloqueio), contendo fonte de energia, identificação, local de bloqueio, método de bloqueio, evidências
# 
# -------------
# 
...
SELECT 
    ...
    LocaisBloqueio_zhZH,
    LocaisBloqueio,
    MetodosBloqueio_ptBR,
    MetodosBloqueio_noNO,
    MetodosBloqueio_enUS,
    MetodosBloqueio_esES,
    MetodosBloqueio_itIT,
    MetodosBloqueio_arSA,
    MetodosBloqueio_svSV,
    MetodosBloqueio_plPL,
    MetodosBloqueio_csCS,
    MetodosBloqueio_frFR,
    MetodosBloqueio_thTH,
    MetodosBloqueio_zhZH,
    MetodosBloqueio,
    EvidenciaId,
    Sequencia,
    Deletado,
    ...
    BloqueioId,
    LocaisBloqueio_deDE,
    MetodosBloqueio_deDE,
    LocaisBloqueio_bgBG,
    MetodosBloqueio_bgBG,
    LocaisBloqueio_roRO,
    MetodosBloqueio_roRO,
    LocaisBloqueio_elEL,
    MetodosBloqueio_elEL,
    LocaisBloqueio_trTR,
    MetodosBloqueio_trTR,
    LOTOBloqueioIdOriginal,
    LocaisBloqueio_esEP,
    MetodosBloqueio_esEP,
    LocaisBloqueio_huHU,
    LocaisBloqueio_nlNL,
    LocaisBloqueio_skSK,
    LocaisBloqueio_ukUA,
    MetodosBloqueio_huHU,
    MetodosBloqueio_nlNL,
    MetodosBloqueio_skSK,
    MetodosBloqueio_ukUA,
    insert_date,
    update_date,
    hash_row
FROM {workspace}.lh_silver.riscos.loto_bloqueio
