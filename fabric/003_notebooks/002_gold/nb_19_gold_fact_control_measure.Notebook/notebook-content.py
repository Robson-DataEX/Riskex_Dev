...
# # Tabela: riscos.fact_control_measure
# ## Objetivo:
# Tabela de aplicação de um controle para mitigar um risco ocupacional. Composto por um Controle, uma Qualidade (se o controle é usado corretamente ou não), e o Risco ocupacional vinculado
# 
# -------------
# 
...
table_name = 'fact_control_measure'
...
SELECT 
    ...
    update_date,
    hash_row
FROM {workspace}.lh_silver.riscos.medida_controle
