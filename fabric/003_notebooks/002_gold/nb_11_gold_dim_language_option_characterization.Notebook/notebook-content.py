...
# 
# # Tabela: riscos.dim_language_option_characterization
# ## Objetivo:
# Tabela de tradução das descrições das opções de caracterização para diferentes idiomas
# 
# -------------
# 
...
table_name = 'dim_language_option_characterization'
...
SELECT 
    ...
    IdiomaId,
    Descricao,
    CaracterizacaoOpcaoIdiomaId,
    insert_date,
    update_date,
    hash_row
FROM {workspace}.lh_silver.riscos.caracterizacao_opcao_idioma
