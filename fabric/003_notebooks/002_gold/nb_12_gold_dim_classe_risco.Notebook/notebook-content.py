...
# 
# # Tabela: riscos.dim_classe_risco
# ## Objetivo:
# Esta tabela os possíveis resultados de um risco ocupacional
# 
# -------------
# 
...
SELECT 
    ...
    ClasseAceitavel,
    SYNC_DATE,
    ClasseRiscoIdioma_Descricao,
    ClasseRiscoIdioma_Criterio,
    insert_date,
    update_date,
    hash_row
FROM {workspace}.lh_silver.riscos.classe_risco
